    ...
    <div class="dropdown">
        ...
        <section>
            ...
            <div class="opcions">
                <div class="row">
                    <div class="mx-auto">
                        <a href="insertar.html" type="button" id="botoOpcions" class="btn btn-link btn-lg">Write a review</a>
                        <a href="consulta.html" type="button" id="botoOpcions" class="btn btn-link btn-lg">Consult books reviews</a>
                    </div>
                </div>
            </div>
